...
type LengthOfString<S extends string, L extends Array<string> = []> = S extends `${infer C}${infer Rest}` ? LengthOfString<Rest, [...L, C ]> : L['length']

type Test = LengthOfString<'leon'>
