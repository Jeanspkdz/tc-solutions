...
type ReplaceKeys<Obj extends object, Keys extends string, Shape extends Record<string, unknown> > = 
  Obj extends Obj 
  ? {
...
type MyTest1 = ReplaceKeys<NodeB | NodeA, 'name' | 'flag', { name: number, flag: string }>
type MyTest2 = ReplaceKeys<Nodes, 'name', { aa: number }>
